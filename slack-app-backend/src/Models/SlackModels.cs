...
namespace SlackAppBackend.Models.Slack
{
    ...
    public class Attachment
    {
        ...
        ///     Text to be shown by Slack clients
        ///     which understand attachments but choose not to show them.
        /// </param>
        ...
        ///     if it contains 700+ characters or 5+ line breaks, and will display
        ...
        ///     the title text will be hyper linked.
        /// </summary>
        ...
        ///     The file size of the image must also be less than 500 KB.For
        ...
        /// <param name="_short">
        ///     A bool to say if the field value is short so
        ///     the field can be displayed side by side with other short fields
        /// </param>
        /// <returns>The updated attachment</returns>
        ...
        ///     Link for the Author, this will
        ///     make the name an hyperlink
        /// </param>
        ...
        /// </summary>
        /// <param name="thumbUrl">
        ///     The url of a small image which will be cropped
        ///     to a 75x75 square
        /// </param>
        /// <returns>The updated attachment</returns>
        ...
        public Attachment SetColor(Color color)
        {
            switch (color)
            {
                case SlackAppBackend.Models.Slack.Color.Red:
                    Color = "danger";
                    break;
                case SlackAppBackend.Models.Slack.Color.Orange:
                    Color = "warning";
                    break;
                case SlackAppBackend.Models.Slack.Color.Green:
                    Color = "good";
                    break;
                default:
                    Color = null;
